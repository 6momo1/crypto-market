...
exports.fetchTokenDatas = exports.TOKENS_BULK = void 0;
 ...
 */
function fetchTokenDatas(tokenAddresses, client, currentEthPrice) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const parsed = (data === null || data === void 0 ? void 0 : data.tokens)
            ? data.tokens.reduce((accum, address) => {
...
exports.fetchTokenDatas = fetchTokenDatas;
