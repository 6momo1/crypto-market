...
var keys_json_1 = __importDefault(require("./keys.json"));
var provider = new ethers_1.ethers.providers.JsonRpcProvider(keys_json_1.default.jsonRPC);
...
var poolContract = new ethers_1.ethers.Contract(poolAddress, poolImmutablesAbi, provider);
